...
class Block extends Model
{
    ...
    public function groups() {
        ...
        return $this->hasMany('App\Group', 'block_name');

    }

    public function images() {

        return $this->hasMany('App\Imageitem', 'block_name');

    }

    public function stringfields() {

        return $this->hasMany('App\Stringfield', 'block_name');

    }

    public function textfields() {

        return $this->hasMany('App\Textfield', 'block_name');

    }

    public function numbs() {

        return $this->hasMany('App\Numb', 'block_name');

    }

    public function bools() {

        return $this->hasMany('App\Bool', 'block_name');
    ...
    public function getGroupItemsArray()
    {
        ...
        $groups = \App\Group::where('block_name','=',$this->name)->with(['stringfields', 'textfields', 'numbs', 'bools', 'images'])->get();
        ...
        foreach($groups as $item)
        {
            ...
            $fields = & $dataArrItem[$item->name]['numbs'];
            foreach($item->numbs as $numb)
            {
                $fields[$item->name] = $numb->value;
            }
