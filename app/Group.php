...
class Group extends Model
{
    ...
    public function images() {
        ...
        return $this->hasMany('App\Imageitem', 'group_id');

    }

    public function stringfields() {

        return $this->hasMany('App\Stringfield', 'group_id');

    }

    public function textfields() {

        return $this->hasMany('App\Textfield', 'group_id');

    }

    public function numbs() {

        return $this->hasMany('App\Numb', 'group_id');

    }

    public function bools() {

        return $this->hasMany('App\Bool', 'group_id');
